...
namespace Tests.Avalara.AvaTax.RestClient.netstandard
{
    ...
    public class BatchRetryTests
    {
        ...
        public void Setup()
        {
            try
            {
                ...
                Client = new AvaTaxClient(typeof(TransactionTests).Name,
                    ...
                    AvaTaxEnvironment.Sandbox, new UserConfiguration { MaxRetryAttempts = -2, TimeoutInMinutes=-2 })
        ...
        /// </summary>
        [Test]
        public async Task BatchesWorkflow_When_Provided_UserCongiguration_Details_Are_Not_In_Range()
        {
