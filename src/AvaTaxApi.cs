...
#region Methods
        ...
        public AddressResolutionModel ResolveAddress(String line1, String line2, String line3, String city, String region, String postalCode, String country, String textCase, Decimal? latitude, Decimal? longitude)
        {
...
#region Asynchronous
        ...
        /// <param name="latitude">Geospatial latitude measurement</param>
        /// <param name="longitude">Geospatial longitude measurement</param>
        public async Task<AddressResolutionModel> ResolveAddressAsync(String line1, String line2, String line3, String city, String region, String postalCode, String country, String textCase, Decimal? latitude, Decimal? longitude)
        {
            var path = new AvaTaxPath("/api/v2/addresses/resolve");
            path.AddQuery("line1", line1);
            path.AddQuery("line2", line2);
